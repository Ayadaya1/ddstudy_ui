...
class CamWidget extends StatefulWidget {
  ...
  const CamWidget({Key? key, required this.onFile}): super(key:key);
...
class CamWidgetState extends State<CamWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    {
      return const Center(child:  Text("Инициализация камеры", style: TextStyle(color: Colors.white)));
    }
    ...
    {
      var scale = (min(constraints.maxWidth, constraints.maxHeight)/max(constraints.maxWidth,constraints.maxHeight))*camera.aspectRatio;
